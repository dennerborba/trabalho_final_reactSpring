...
export default function EditarAvaliacao() {
    ...
    const {idRestaurante, idAvaliacao} = useParams()


    function editarComentario() {
        let obj = { comentario: comentario, classificacao: classificacao };
        fetch(`http://localhost:8080/restaurantes/${idRestaurante}/avaliacoes/${idAvaliacao}`, {
          method: 'PUT',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify(obj)
        })
        .then(x => alert('A avaliação foi editada.'));
      }
                    ...
                    <div className="col-md-10 mx-auto col-lg-5">
                        <form className="p-4 p-md-8 border rounded-3 bg-dark text-white">
                            ...
                            <div className="mt-3 d-flex justify-content-around">
                                <button onClick={editarComentario} className="btn btn-outline-success">Salvar</button>
